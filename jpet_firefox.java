...
public class jpet_firefox {
  ...
  @BeforeClass
  public void chrome() {
	  dr=a1.launch_browser("FIREFOX", url);
  ...
  public void reg() {
	  a1=new utilities(dr);
	  a2=new jpet_reg(dr);
	  a2.do_reg("balaji11", "Balaji1234", "Balaji1234", "balaji111", "dfjsd", "bal@gmail.com", "6462541512", "jdhf", "hdjf", "jhdjf", "djhf", "563456", "djhfk", "dfjid", "hfd");
	  a3=new login(dr);
